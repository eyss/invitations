...
This folder has an example DNA for the `invitations` zome. The actual code for the zome is in `zomes/invitations`.
...
This should create a `workdir/happ/invitations.happ` file.
